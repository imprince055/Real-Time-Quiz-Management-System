  ...
  return (
    <Routes>
      ...
      <Route path="/student/dashboard"
        element={<StudentRoute><StudentDashboardPage /></StudentRoute>} />
      {/*
        /student/profile-setup — intentionally NOT wrapped in StudentRoute.
        The user arrives here without a studentToken yet (they only have a
        short-lived setupToken in the URL). Wrapping it in StudentRoute would
        redirect them to /student/login, breaking the onboarding flow.
      */}
      <Route path="/student/profile-setup" element={<StudentProfileSetupPage />} />
